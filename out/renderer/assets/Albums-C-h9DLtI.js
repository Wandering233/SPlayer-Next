import { _ as __unplugin_components_1 } from "./disc3-D5n43yM1.js";
import { _ as _sfc_main$1 } from "./CoverList.vue_vue_type_script_setup_true_lang-ChKIaOwW.js";
import { u as useI18n, aC as useStreamingStore, s as storeToRefs, c as useRouter, aS as albumsToCoverItems } from "./index-DVKNk9gd.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const items = computed(() => albumsToCoverItems(albums.value));
    const handleClick = (item) => {
      router.push(`/collection/streaming/album/${encodeURIComponent(item.id)}`);
    };
    return (_ctx, _cache) => {
      const _component_CoverList = _sfc_main$1;
      const _component_IconLucideDisc3 = __unplugin_components_1;
      return openBlock(), createElementBlock("div", _hoisted_1, [
        unref(albums).length > 0 ? (openBlock(), createBlock(_component_CoverList, {
          key: 0,
          items: unref(items),
          "padding-x": 20,
          "padding-top": 8,
          ...
          createBaseVNode("div", _hoisted_3, [
            createVNode(_component_IconLucideDisc3, { class: "size-12 mx-auto mb-3 opacity-30" }),
