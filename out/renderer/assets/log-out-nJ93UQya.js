...
import { u as useI18n, a as useSettingsStore, f as dialog } from "./index-DVKNk9gd.js";
import { a as _sfc_main$1, _ as _sfc_main$2 } from "./SCheckbox.vue_vue_type_script_setup_true_lang-Cne9YtVQ.js";
import { k as onMounted, L as onBeforeUnmount, r as ref, H as h, c as computed, m as markRaw, C as openBlock, y as createElementBlock, z as createBaseVNode, x as defineComponent, v as unref, D as createVNode, Q as withCtx, B as createCommentVNode, P as createBlock, R as resolveDynamicComponent } from "./runtime-dom.esm-bundler-qZya7aYr.js";
import { _ as __unplugin_components_5, I as IconCopy } from "./copy-DhNjJWGd.js";
...
const useWindowControls = () => {
  ...
  const toggleFullscreen = () => window.api.window.toggleFullscreen();
  const hide = () => window.api.window.hide();
  const quit = () => window.api.window.quit();
  const close = async () => {
    ...
    const choice = ref(appearance.closeAction);
    ...
    const confirmed = await dialog.confirm({
      ...
      body: () => h("div", { class: "flex flex-col gap-4" }, [
        ...
        h(_sfc_main$2, {
          ...
          "onUpdate:checked": (v2) => remember.value = v2
        })
      ])
    });
    if (!confirmed) return;
  ...
  let offFs = null;
  onMounted(() => {
    window.api.window.isMaximized().then((m2) => isMaximized.value = m2);
    window.api.window.isFullscreen().then((f2) => isFullscreen.value = f2);
    offMax = window.api.window.onMaximizeChange((m2) => isMaximized.value = m2);
    offFs = window.api.window.onFullscreenChange((f2) => isFullscreen.value = f2);
  });
  onBeforeUnmount(() => {
    offMax?.();
    offFs?.();
...
const IconSquare = markRaw({ name: "lucide-square", render: render$2 });
const _hoisted_1$2 = {
  key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return unref(isBorderless) ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
        createVNode(_component_SButton, {
          class: "window-control-button app-no-drag",
          type: __props.cover ? "cover" : void 0,
          variant: __props.cover ? "ghost" : "tertiary",
          circle: "",
          size: 40,
          "icon-size": 16,
          onClick: unref(minimize)
        }, {
          icon: withCtx(() => [
            createVNode(unref(__unplugin_components_5))
          ]),
          _: 1
        }, 8, ["type", "variant", "onClick"]),
        createVNode(_component_SButton, {
          class: "window-control-button app-no-drag",
          type: __props.cover ? "cover" : void 0,
          variant: __props.cover ? "ghost" : "tertiary",
          ...
          size: 40,
          "icon-size": 16,
          onClick: unref(toggleMaximize)
        }, {
          icon: withCtx(() => [
            (openBlock(), createBlock(resolveDynamicComponent(unref(isMaximized) ? unref(IconCopy) : unref(IconSquare))))
          ]),
          _: 1
        }, 8, ["type", "variant", "onClick"]),
        createVNode(_component_SButton, {
...
const __unplugin_components_9 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-96513beb"]]);
const _hoisted_1$1 = {
  viewBox: "0 0 24 24",
  width: "1em",
  height: "1em"
...
const __unplugin_components_0 = markRaw({ name: "lucide-chevron-left", render: render$1 });
function C() {
...
const __unplugin_components_2 = markRaw({ name: "lucide-log-out", render });
export {
  __unplugin_components_0 as _,
  __unplugin_components_9 as a,
  __unplugin_components_2 as b,
  f,
  useWindowControls as u
};
